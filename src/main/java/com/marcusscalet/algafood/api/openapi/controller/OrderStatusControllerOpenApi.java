...
public interface OrderStatusControllerOpenApi {
	...
	void confirmedStatus(@ApiParam(value = "Código do pedido", example = "f9981ca4-5a5e-4da3-af04-933861df3e55", 
    ...
    @ApiResponses({
        ...
        @ApiResponse(code = 404, message = "Pedido não encontrado", response = Problem.class)})
	void deliveredStatus(@ApiParam(value = "Código do pedido", example = "f9981ca4-5a5e-4da3-af04-933861df3e55", 
            required = true) String orderCode);
    ...
    @ApiResponses({
        ...
        @ApiResponse(code = 404, message = "Pedido não encontrado", response = Problem.class)})
	void cancelledStatus(@ApiParam(value = "Código do pedido", example = "f9981ca4-5a5e-4da3-af04-933861df3e55", 
            required = true) String orderCode);
}
