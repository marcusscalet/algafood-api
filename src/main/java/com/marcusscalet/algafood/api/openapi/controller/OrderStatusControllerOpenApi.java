...
public interface OrderStatusControllerOpenApi {
	...
	public void confirmedStatus(@ApiParam(value = "Código do pedido", example = "f9981ca4-5a5e-4da3-af04-933861df3e55", 
	...
	public void deliveredStatus(@ApiParam(value = "Código do pedido", example = "f9981ca4-5a5e-4da3-af04-933861df3e55", 
            required = true) String orderCode);
	...
	public void cancelledStatus(@ApiParam(value = "Código do pedido", example = "f9981ca4-5a5e-4da3-af04-933861df3e55", 
            required = true) String orderCode);
}
