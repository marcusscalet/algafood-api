...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<?> handlingEntityNotFoundException(
	...
	public ResponseEntity<?> handlingEntityInUseException(
	...
	public ResponseEntity<?> handlingGenericException(GenericException ex, WebRequest request) {
